...
const AGENTS: Record<AgentId, Agent> = {
  ...
  'punch-oracle': {
    ...
    mockResponse: 'Prediction punched! 1000 $PUNCHMONKEY staked on [SOL > $300 by Mar 1]. Current odds: 45%. 🔮👊'
  },
  'trend-puncher': {
    id: 'trend-puncher',
    name: 'TREND PUNCHER',
    ...
    placeholder: "Command... (e.g., 'Buy $500 of attention shares on #PunchMonkey')",
    systemMessage: 'ATTENTION MARKETS SCANNING. TREND ANALYSIS ACTIVE.',
    mockResponse: 'Position acquired! Bought 5,200 attention shares on #PunchMonkey narrative. Monitoring virality via Zora oracles. 📈🔥'
  },
  'vault-swinger': {
    id: 'vault-swinger',
    name: 'VAULT SWINGER',
